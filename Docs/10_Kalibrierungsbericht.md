...
- **Stichprobe von 1:** `TEMPERATURE = 0.0` macht die Generierung nicht deterministisch — jeder Kontext wurde in Schicht B genau einmal gesampelt, nicht mehrfach gemittelt. Kein theoretisches Risiko: derselbe Lauf mit demselben empfohlenen Set (identische zehn Werte) ergab am Vortag (2026-09-15T19-03-53Z) eine False-Suppression-Rate von 26,7 % auf demselben Holdout, dieser Lauf (2026-09-16T14-47-13Z) 33,3 % — eine Differenz von 6,7 Prozentpunkten, entsprechend einer Frage von 15, allein aus Lauf-zu-Lauf-Streuung gegen die Live-API bei identischem Code. T-62 (#136) bestätigt das unabhängig: `gpt-4o-mini` lieferte dort zwischen zwei Tagen bei identischem Code und `TEMPERATURE = 0` 15 von 80 Antworten anders (`R00_Baseline.md`).
