...
- **−** Bei vielen grossen Dokumenten wächst die Datenbankgrösse schnell. Für den Pilot (geschätzt < 500 Dokumente) kein Problem. Post-MVP: Migration zu Azure Blob Storage falls Datenbankgrösse oder Redundanz-Anforderungen steigen.
